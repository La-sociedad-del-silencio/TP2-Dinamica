...
Este es el caso cuando todos los datos de $x_i$ son menores al resultado de $f(0)$. Esto se debe a que el resultado será predecible ya que se podría derrotar al 100\% de enemigos en todos los ataques sin necesidad de cargar fuerzas.

El algortimo en este caso simplemente ejecutaría una operación $O(n)$ para verificar si es optimizable y con $O(n)$ suma la totalidad de enemigos derrotados.
