...
\begin{itemize}
    ...
    \begin{itemize}
        \item Ver cual de todos los ejemplos aplicarle volumen
    \end{itemize}
    \item Relación numérica entre $x_i$ y $f(j)$
        \begin{itemize}
        \item \texttt{x\_menor\_a\_f:} Todos los $x_i$ son menores a todos los $f(j)$
        \item \texttt{x\_menor\_a\_f0:} Todos los $x_i$ son menores a $f(0)$
        \item \texttt{x\_mayor\_a\_f:} Todos los $x_i$ son mayores a todos los $f(j)$
        \item \texttt{x\_mayor\_a\_f0:} Todos los $x_i$ son mayores a $f(0)$
        \item \texttt{x\_igual\_a\_f:} Todos los $x_i$ sin iguales a todos los $f(j)$ (con $i$ == $j$)
        \item \texttt{x\_igual\_a\_f\_siempre:} Todos los $x_i$ sin iguales a todos los $f(j)$ (para todo $i$, $j$)
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{dif\_f\_cero:} La diferencia numérica entre cada $f(j)$ es nula
    ...
    \end{itemize}
    \item Ordenamiento de $x_i$ y $f(j)$
    \begin{itemize}
        ...
        \item \texttt{fj\_descendente:} Los $f(j)$ están ordenados de manera descendente
        \item \texttt{fj\_ascendente:} Los $f(j)$ están ordenados de manera ascendente
    \end{itemize}
\end{itemize}
